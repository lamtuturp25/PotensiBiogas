...
var style_PotensiBiogasKWh_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Potensi Bi");
    ...
    if (value >= 28157426.252526 && value <= 454310805.041543) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 454310805.041543 && value <= 1662640155.268610) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1662640155.268610 && value <= 2973169610.650769) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2973169610.650769 && value <= 4719169256.625235) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4719169256.625235 && value <= 19429401882.315720) {
            style = [ new ol.style.Style({
